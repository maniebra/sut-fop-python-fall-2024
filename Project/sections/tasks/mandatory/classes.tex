...
توجه کنید که ممکن است به ساختار‌های بیشتری نیاز پیدا کنید که نیازسنجی و پیاده‌سازی آن‌ها بر عهده‌‌ی شماست. همچنین می‌توانید برای پیاده‌سازی این بخش به‌جای \lr{dictionary} از \lr{named tuples} استفاده نمایید.